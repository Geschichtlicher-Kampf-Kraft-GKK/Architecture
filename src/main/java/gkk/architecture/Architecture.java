...
public class Architecture {
  ...
  public static class Blocks {
    /*
     * public static final MySpecialBlock mySpecialBlock = null; // placeholder for
     * special block below
     */
  }
  ...
  public static class Items {
    /*
     * public static final ItemBlock mySpecialBlock = null; // itemblock for the
     * block above public static final MySpecialItem mySpecialItem = null; //
     * placeholder for special item below
     */
  }
  ...
  public static class ObjectRegistryHandler {
    ...
    public static void addItems(RegistryEvent.Register<Item> event) {
       ...
       * ItemBlock(Blocks.myBlock).setRegistryName(MOD_ID, "myBlock"));
       * event.getRegistry().register(new MySpecialItem().setRegistryName(MOD_ID,
       * "mySpecialItem"));
       */
    }
  ...
  /*
   * EXAMPLE ITEM AND BLOCK - you probably want these in separate files public
   * static class MySpecialItem extends Item {
   * 
   * }
   * 
